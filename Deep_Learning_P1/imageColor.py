...
history=Model_Colourization.fit(normalized_gray_tensors,normalized_color_tensors,epochs=40,verbose=1,steps_per_epoch=10,shuffle=True,batch_size=64)
...
image_data = (Predicted_color_images[3] * 255).astype('uint8')
display(image_data)
...
image_data = Y_test.iloc[3]  # Replace with your actual image data
...
#Create a NumPy ndarray with shape (200, 200, 3) for demonstration (replace this with your own ndarray)
image_data = X_test.iloc[3]  # Replace with your actual image data
